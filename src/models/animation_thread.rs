...
// use model_data_structures::models::model_data::ModelData;
...
//   ///
//   /// The only way to access this will be through an [`AnimationConnection`](AnimationConnection), which will only ever be owned by the screen.
